...
/***/ function(module, exports, __webpack_require__) {
	...
	var SectionsListView = __webpack_require__(4);
	var CommentsListView = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SectionsListView = function SectionsListView() {
...
/***/ function(module, exports) {
	...
	with (obj) {
	__p += '<div class="control">\n  <input type="submit" id="addNewItem" value="Добавить тему">\n</div>\n<h2>Список разделов и тем</h2>\n<div class="sections-list">\n  ';
	 for( var i = 0; i < sectionsList.length; i++) {;
	__p += '\n    <div class="section">\n      <h3>' +
	((__t = ( sectionsList[i].title )) == null ? '' : __t) +
	'</h3>\n      <ul class = "items">\n        ';
	 for( var j = 0; j < sectionsList[i].itemsList.length; j++) {;
	__p += '\n          <li data-id="' +
	((__t = (sectionsList[i].itemsList[j].id )) == null ? '' : __t) +
	'">' +
	((__t = ( sectionsList[i].itemsList[j].title )) == null ? '' : __t) +
	'</li>\n        ';
	 }; ;
	__p += '\n      </ul>\n    </div>\n  ';
	 }; ;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommentsListView = function CommentsListView(id) {
	    this.super.constructor.apply(this);
	    this.template = template;
	    this.promise = null;
	    this.itemId = id;
...
/***/ function(module, exports) {
	...
	'</h2>\n<div class="comments-list">\n  ';
	 for( var i = 0; i < item.commentsList.length; i++) {;
	__p += '\n    <div class="comment">\n      <div class="users-info">\n         <span class="name">' +
	((__t = ( item.commentsList[i].username )) == null ? '' : __t) +
	'</span>\n         <div class="date">' +
	((__t = ( item.commentsList[i].date )) == null ? '' : __t) +
	'</div>\n      </div>\n      <p class="text-comment">' +
	((__t = ( item.commentsList[i].text )) == null ? '' : __t) +
	'</p>\n    </div>\n  ';
	 }; ;
