...
/***/ function(module, exports, __webpack_require__) {
	...
	var SectionRouter = __webpack_require__(4);
	var IndexRouter = __webpack_require__(36);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Backbone = __webpack_require__(1);
	var SectionListController = __webpack_require__(5);
	var SectionDetailsController = __webpack_require__(15);
	var ItemDetailsController = __webpack_require__(23);
	...
	module.exports = Backbone.Router.extend({
	    ...
	    changePage: function changePage(controller, params) {
	    ...
	    sectionItem: function sectionItem(id) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BasicController = __webpack_require__(6);
	var SectionCollection = __webpack_require__(7);
	var SectionListView = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = Backbone.Model.extend({
	    ...
	    getItems: function getItems(items) {
	        return _.map(this.get("itemsId"), function (i) {
	            return items.get(i);
	        });
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SectionView = __webpack_require__(10);
	var template = __webpack_require__(13);
	var templPopup = __webpack_require__(14);
	var Section = __webpack_require__(8);
...
/***/ function(module, exports) {
	...
	'</p>\n  </div>\n  <div class="button" id="deleteSection"></div>\n';
	 } else {;
...
/***/ function(module, exports) {
	...
	var __t, __p = '';
	with (obj) {
	__p += '<div class="control">\n    <input type="submit" id="addNewSection" value="Добавить раздел">\n</div>\n<h2>Список разделов</h2>\n';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BasicController = __webpack_require__(6);
	var ItemCollection = __webpack_require__(16);
	var SectionDetailsView = __webpack_require__(18);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Backbone = __webpack_require__(1);
	var Item = __webpack_require__(17);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = Backbone.Model.extend({
	    ...
	    getComments: function getComments(comments) {
	        return _.map(this.get("commentsId"), function (i) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var templPopup = __webpack_require__(20);
	var ItemView = __webpack_require__(21);
	...
	module.exports = Backbone.View.extend({
	    ...
	    initialize: function initialize(section) {
...
/***/ function(module, exports) {
	...
	var __t, __p = '';
	with (obj) {
	__p += '<div class="control">\n    <input type="submit" id="back" value="Назад">\n    <input type="submit" id="addNewItem" value="Добавить тему">\n</div>\n<h2>Список тем раздела "' +
	((__t = (title)) == null ? '' : __t) +
	'"</h2>\n';
...
/***/ function(module, exports) {
	...
	__p += '\n  <h3>' +
	((__t = ( title )) == null ? '' : __t) +
	'</h3>\n  <div class="button" id="deleteItem"></div>\n';
	 } else {;
	__p += '\n  <h3 class="noAuth">' +
	((__t = ( title )) == null ? '' : __t) +
	'</h3>\n';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BasicController = __webpack_require__(6);
	var CommentCollection = __webpack_require__(24);
	var ItemDetailsView = __webpack_require__(26);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var templPopup = __webpack_require__(28);
	var CommentView = __webpack_require__(29);
	var Items = __webpack_require__(16);
	var Comment = __webpack_require__(25);
	var Quill = __webpack_require__(31);
...
/***/ function(module, exports) {
	...
	var __t, __p = '';
	with (obj) {
	__p += '<div class="control">\n  <input type="submit" id="back" value="Назад">\n  <input type="submit" id="addNewComment" value="Добавить комментарий">\n</div>\n<h2>' +
	((__t = ( title )) == null ? '' : __t) +
	'</h2>\n';
...
/***/ function(module, exports) {
	...
	function print() { __p += __j.call(arguments, '') }
	with (obj) {
	__p += '<div class="comment-avatar"></div>\n<div class="comment-author">' +
	...
	'</div>\n</div>\n';
	 if (config) {;
	__p += '\n  <div class="button2" id="deleteComment"></div>\n';
	 } ;
	__p += '\n';
